...
@app.route('/index')
def index():
    return "<!DOCTYPE html><meta name='viewport' content='width=device-width, initial-scale=1'>Welcome to nonhumanworks.com! Simply pass in the phrase (even including spaces) you want to use in the url itself, for example <a href='https://nonhumanworks.com/api/dogs%20playing%20golf'>https://nonhumanworks.com/api/dogs in space</a>"
...
def queue_list():
    ...
    return f"<!DOCTYPE html><meta name='viewport' content='width=device-width, initial-scale=1'><body style='font-family:monospace;'><h4>Queue to process:<br><br> {fixedstring}</h4><h4>Currently working on: <a target='_blank' href='https://nonhumanworks.com/api/current'>{current}</a></h4></body>"
